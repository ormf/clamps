...
(mapcar
   ...
   ("controller-window" "clamps-dict/controller-window.html")
   ...
   ("digest-poolplayer-preset-form-to-array" "clamps-dict/digest-poolplayer-preset-form-to-array.html")
   ...
   ("faderfox-gui-f.orm" "clamps-dict/faderfox-gui-f.orm.html")
   ...
   ("nanoktl2-preset-gui-f.orm" "clamps-dict/nanoktl2-preset-gui-f.orm.html")
   ...
   ("play-buffer-stretch-env-pan-bus-out*" "clamps-dict/play-buffer-stretch-env-pan-bus-out.html")
