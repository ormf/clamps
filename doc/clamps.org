...
*** Reading the Documentation
    ...
    Below is a graph of "dependencies" of the package
    explanations. The entries at the end of an arrow indicate that
    they can only be fully understood, when the documentation of the
    entry at the start of the array is understood. The reader may
    construct her or his individual reading path from these
    dependencies:

    [[clamps]] -> [[cl-refs]] -> [[cl-midictl]]

    [[cl-refs]] -> [[clog-dsp-widgets]]

    [[of-incudine-dsps]] -> [[incudine-bufs]] -> [[cl-sfz]] -> [[cm-sfz]]

    [[cm-svg]] -> [[cm-svg.rts]]

    [[General Incudine Setup]] -> [[of-incudine-dsps]]
...
**** Excursion: Closures
    ...
    have been dedicated to their exploration[fn:0]. But as in real
...
** cl-refs
   ...
   certain situations, like reacting to external events, etc.[fn:6]
...
**** watch
     ...
     with the change of ref-objects[fn:8]. Since actions can also
     ...
     variables and associated actions[fn:9].
...
[fn:0] For examples see Dan Graham's famous book "On Lisp" or Doug
...
[fn:6] With the notable exception of a value bound by /defconstant/,
as a constant is an /immutable/ value, which never changes.

[fn:7] The implementation ideas are similar to javascript frameworks
...
[fn:8] In Lisp parlance this is the classic example of a
/side-effect/.

[fn:9] For people used to patcher based systems like [[https://en.wikipedia.org/wiki/Pure_Data][Pure Data]] or
