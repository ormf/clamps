...
*** CLOG
    ...
    definition of the Common Lisp Standard in 1990 predating the
...
*** Dependencies
    ...
    - sbcl
*** Preparation
    - Download the file [[https://github.com/ormf/clamps/blob/main/extra/quicklisp-install.sh][quicklisp-install.sh]] from the clamps
      repository and put it into the /tmp/ folder.
