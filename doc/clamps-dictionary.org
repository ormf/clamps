...
** count-elements
   Function
   #+BEGIN_SRC lisp
     (count-elements seq &key (test #'eql) (key (function identity)) (sort t))
   #+END_SRC
...
** flatten-fn
   Function
   #+BEGIN_SRC lisp
     (flatten-fn seq &key (test #'atom) (key (function identity)))
   #+END_SRC
...
** group-by-key
   Function
   #+BEGIN_SRC lisp
     (group-by-key source &key (test #'=) (key (function car)))
   #+END_SRC
...
** sort-by
   Function
   #+BEGIN_SRC lisp
     (sort-by list &key (test #'<) (key (function identity)))
   #+END_SRC
** spit
   Function
   #+BEGIN_SRC lisp
...
** splice
   Function
   #+BEGIN_SRC lisp
     (splice list &key (key #'first) (test (function eq)))
   #+END_SRC
